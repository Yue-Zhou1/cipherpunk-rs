    ...
    <AnimatePresence>
      ...
      >
        ...
        <button
          ...
          role="menuitem"
        >
          <span>↑</span> Show callers{" "}
          <span className="explorer-ctx-menu-count">({callerCount})</span>
        </button>
        <button
          className="explorer-ctx-menu-item"
          onClick={() => {
          ...
          role="menuitem"
        >
          <span>↓</span> Show callees{" "}
          <span className="explorer-ctx-menu-count">({calleeCount})</span>
        </button>
        <button
          className="explorer-ctx-menu-item"
          onClick={() => {
